package projectgoodquartz.config;
...
import projectgoodquartz.util.BaseJob;
...
public class InitStartSchedule implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		for (JobConfig sysJob:jobList) {
			...
			if (StringUtils.isNotEmpty(sysJob.getJobDateMap())) {
				JSONObject jb = JSONObject.parseObject(sysJob.getJobDateMap());
